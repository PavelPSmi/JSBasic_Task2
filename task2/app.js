...
function fold(oneNumberTask4, twoNumberTask4) {
    alert(Math.round(oneNumberTask4 + twoNumberTask4));
    return;
}
function subtract(oneNumberTask4, twoNumberTask4) {
    alert(Math.round(oneNumberTask4 - twoNumberTask4));
    return;
}
function multiply(oneNumberTask4, twoNumberTask4) {
    alert(Math.round(oneNumberTask4 * twoNumberTask4));
    return;
}
function share(oneNumberTask4, twoNumberTask4) {
    alert(Math.round(oneNumberTask4 / twoNumberTask4));
    return;
}
//ЗАДАЧА 5
let operation = prompt("+,-,*,/");
function mathOperation(oneNumberTask4, twoNumberTask4, operation) {
    switch (operation) {
        case "+":
            return fold(oneNumberTask4, twoNumberTask4);
        case "-":
            return subtract(oneNumberTask4, twoNumberTask4);
        case "*":
            return multiply(oneNumberTask4, twoNumberTask4);
        case "/":
            return share(oneNumberTask4, twoNumberTask4);
    }
}    
// fold(oneNumberTask4, twoNumberTask4);
// subtract(oneNumberTask4, twoNumberTask4);
// multiply(oneNumberTask4, twoNumberTask4);
// share(oneNumberTask4, twoNumberTask4);
mathOperation(oneNumberTask4, twoNumberTask4, operation)